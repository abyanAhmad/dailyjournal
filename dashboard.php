        ...
        <div class="card border border-info mb-3 shadow" style="max-width: 18rem;">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="p-3">
                        <span class="badge rounded-pill text-bg-info fs-2"><?php echo $jumlah_article; ?></span>
                    </div> 
                </div>
            </div>
        </div>
        ...
        <div class="card border border-info mb-3 shadow" style="max-width: 18rem;">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="p-3">
                        <span class="badge rounded-pill text-bg-info fs-2"><?php //echo $jumlah_gallery; ?></span>
                    </div> 
                </div>
            </div>
        </div>
